                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 d-none d-md-block">
                            <div class="logo">
                                <a href="index.html"><img src="{{ asset('assets/img/logo/logo_real.ico') }}"
                                        alt=""></a>
                            </div>
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="text">
                                <a href="index.html" class="navbar-brand"
                                    style="font-weight: bold; font-size: 24px; color: green;">خَيْرُ النَّاسِ
                                    أَنْفَعُهُمْ لِلنَّاسِ</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#ppdbModal">Registration PPDB</a></li>
                                                <li><a href="frontsiswa">Data Student New</a></li>
                                                <li><a href="frontstruktur">Struktur Organisasi</a></li>
