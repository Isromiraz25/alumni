<main>
                            ...
                            <div class="properties__button">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Mudir</a>
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Info Bursa</a>
                                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Info alumni</a>
                                        <a class="nav-item nav-link" id="nav-last-tab" data-toggle="tab" href="#nav-last" role="tab" aria-controls="nav-contact" aria-selected="false">Info santri</a>
                                        ...
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="whats-news-single mb-40 mb-40">
                                                ...
                                                <div class="whates-img">
                                                    <img src="{{ asset($item->photo) }}" alt="" width="500" height="450" >
                                                </div>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="single-box">
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="https://www.facebook.com/people/Ponpes-Tafriijul-Ahkam/pfbid036wBQCAHzDsy5uNeXL83VsMi6DqEW2sKywW4ag7qZoidj3uvdyKQmjFcXA55tmow7l/"><img src="assets/img/news/icon-fb.png" alt=""></a>
                                </div>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="https://www.facebook.com/people/Ponpes-Tafriijul-Ahkam/pfbid036wBQCAHzDsy5uNeXL83VsMi6DqEW2sKywW4ag7qZoidj3uvdyKQmjFcXA55tmow7l/"><img src="assets/img/news/icon-tw.png" alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>Ponpes </span>
                                    <p>Tafriijul Ahkam</p>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="https://www.instagram.com/p/CwG_Z1Wphp9/?igsh=MTV0NnVmMW1wcjlpdA%3D%3D&img_index=1"><img src="assets/img/news/icon-ins.png" alt=""></a>
                                </div>
                                <div class="follow-count">
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="https://www.youtube.com/@mediatafriijulahkam8972"><img src="assets/img/news/icon-yo.png" alt=""></a>
                                </div>
                                <div class="follow-count">
                    ...
                    <div class="most-recent-area">
                        ...
                        <div class="most-recent-single">
                                ...
                                @php
                                $total_angkatan = DB::table('alumnis')->where('angkatan_id',$item->id)->count();
                                @endphp
                                        <tr>
                                            <th scope="row">{{ $no++ }}</th>
                                            ...
                                            <th scope="row" class="btn-sx btn-show-alumni"data-id="{{ $item->id }}"><i class="fa fa-eye" aria-hidden="true"></i></th>
                                        </tr>
                              @endforeach
                                    </tbody>
                                </table>
    ...
    <div class="modal fade" id="showAllAlumni" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="weekly3-news-active dot-style d-flex">
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset($item->photo) }}" alt="" width="400" height="200" style="object-fit: cover;">
                                            </div>
